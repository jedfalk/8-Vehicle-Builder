    ...
    .then((answers) => {
      ...
      if (vehicleToTow) {
        if (vehicleToTow instanceof Truck) {
          console.log('This truck cannot tow another truck.');
          this.performActions();  // After the message, return to perform actions
        } else {
          truck.tow(vehicleToTow);
          console.log(`Successfully towed ${vehicleToTow.make} ${vehicleToTow.model}.`);
          this.performActions();  // After towing, return to perform actions
        }
      }
    });
}
